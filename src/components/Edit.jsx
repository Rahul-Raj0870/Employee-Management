  ...
  return (
    <div style={{ maxWidth: '500px', margin: '2rem auto' }}>
      <div className="shadow p-4" style={{ borderRadius: '40px', backgroundColor: 'white' }}>
        <h1 className='text-center py-2 fw-bolder text-primary-emphasis'>Edit Employee</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='mb-3 text-center'>
            <Button 
              ...
              variant="contained" 
              color="primary" 
              style={{ width: '150px', height: '50px', marginRight: '20px', backgroundColor: 'orangered' }}
            >
              Update
            </Button>
            <Button 
