...
const Add = () => {
  ...
  return (
    <div style={{ maxWidth: '500px', margin: '2rem auto' }}>
      <div className="shadow p-4" style={{ borderRadius: '40px', backgroundColor: 'white' }}>
        <h1 className='text-center py-2 fw-bolder text-info-emphasis'>Add Employee</h1>
        <form>
          <div className='mb-3'>
            <TextField
              name='id'
          ...
          <div className='mb-3 text-center'>
            <Button onClick={handleSubmit} disabled={!isFormValid} style={{ width: '150px', height: '50px', marginRight: '20px', backgroundColor: isFormValid ? 'green' : 'grey' }} variant="contained">
              Add Employee
            </Button>
